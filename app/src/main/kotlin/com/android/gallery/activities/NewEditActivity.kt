...
import com.android.gallery.asynctasks.CopyMoveTask
import com.android.gallery.extensions.*
import com.android.gallery.helpers.CONFLICT_OVERWRITE
import com.android.gallery.helpers.PERMISSION_WRITE_STORAGE
import com.android.gallery.helpers.REAL_FILE_PATH
import com.android.gallery.helpers.isNougatPlus
import com.android.gallery.interfaces.CopyMoveListener
import com.android.gallery.models.FileDirItem
import com.android.gallery.R
import com.android.gallery.dialogs.SaveAsDialog
import com.android.gallery.extensions.config
import com.android.gallery.extensions.fixDateTaken
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, resultData: Intent?) {
        if (requestCode == PESDK_EDIT_IMAGE) {
            ...
            if (resultCode != Activity.RESULT_OK || sourceImageUri == null || sourceImageUri.toString().isEmpty() || cacheImagePathFromEditor.isEmpty() || sourceImageUri.toString() == cacheImagePathFromEditor) {
                ...
                // the image is stored at the internal app storage first, for example /data/user/0/com.android.gallery/cache/editor/IMG_20191207_183023.jpg
