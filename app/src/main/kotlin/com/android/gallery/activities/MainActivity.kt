...
import com.android.gallery.dialogs.ConfirmationDialog
import com.android.gallery.dialogs.CreateNewFolderDialog
import com.android.gallery.dialogs.FilePickerDialog
import com.android.gallery.extensions.*
import com.android.gallery.helpers.*
import com.android.gallery.models.FileDirItem
import com.android.gallery.models.Release
import com.android.gallery.views.MyGridLayoutManager
import com.android.gallery.views.MyRecyclerView
import com.android.gallery.BuildConfig
import com.android.gallery.R
import com.android.gallery.adapters.DirectoryAdapter
import com.android.gallery.databases.GalleryDatabase
import com.android.gallery.dialogs.ChangeSortingDialog
import com.android.gallery.dialogs.ChangeViewTypeDialog
import com.android.gallery.dialogs.FilterMediaDialog
import com.android.gallery.extensions.*
import com.android.gallery.helpers.*
import com.android.gallery.interfaces.DirectoryOperationsListener
import com.android.gallery.jobs.NewPhotoFetcher
import com.android.gallery.models.Directory
import com.android.gallery.models.Medium
...
class MainActivity : SimpleActivity(), DirectoryOperationsListener {
    ...
    private val NEW_APP_PACKAGE = "com.android.clock"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*if (System.currentTimeMillis() < 1523750400000 && !config.wasNewAppShown && config.appRunCount > 100 && config.appRunCount % 50 != 0 && !isPackageInstalled(NEW_APP_PACKAGE)) {
            ...
            NewAppDialog(this, NEW_APP_PACKAGE, "Clock")
        }*/
    ...
    private fun tryLoadGallery() {
        handlePermission(PERMISSION_WRITE_STORAGE) {
            if (it) {
                if (!config.wasUpgradedFromFreeShown && isPackageInstalled("com.android.gallery")) {
